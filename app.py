...
# AI OCR module is not available, so related functionality is disabled
enhance_text_with_ai = None
get_ocr_tool_references = lambda: {"error": "AI OCR tools not available"}
    ...
    try:
        ...
        try:
            ...
            try:
                ...
                # AI enhancement is not available, fallback to offline processing
                enhanced_result = enhance_text_offline(extracted_text)
                response = {
                    "text": enhanced_result["enhanced_text"],
                    "original_text": extracted_text,
